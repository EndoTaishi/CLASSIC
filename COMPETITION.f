...
C
      INTEGER N, K, INIRANK(6), T1(ILG), RANK(ILG,ICC-2), K1, K2, L,
...
C
      DO 310 I = IL1, IL2 
        IF(USENPPVG(I,GRASSONE).GE.USENPPVG(I,GRASSTWO))THEN 
          RANK(I,GRASSONE-NUMCROPS)=GRASSONE-NUMCROPS
          RANK(I,GRASSTWO-NUMCROPS)=GRASSTWO-NUMCROPS
        ELSE IF(USENPPVG(I,GRASSTWO).LT.USENPPVG(I,GRASSTWO))THEN
          RANK(I,GRASSONE-NUMCROPS)=GRASSTWO-NUMCROPS
          RANK(I,GRASSTWO-NUMCROPS)=GRASSONE-NUMCROPS
        ENDIF
310   CONTINUE
C
