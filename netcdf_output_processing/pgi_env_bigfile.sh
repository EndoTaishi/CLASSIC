...
#writer
pgf90 -Bstatic creator_module_bigfile.f90 netcdf_writer_bigfile.f90 -I /usr/local/netcdf-4.1.3/include -o netcdf_writer_bf  -L/usr/local/netcdf-4.1.3/lib -lnetcdff -lnetcdf -L/usr/local/hdf5-1.8.7/lib -lhdf5_hl -lhdf5 -L/usr/local/zlib-1.2.5 -lz -lm -lhdf5_hl -lhdf5 -lz -lcurl -L/usr/local/hdf5-1.8.7/lib -lhdf5_hl -lhdf5 -L/usr/local/zlib-1.2.5/lib -lz -lcurl
