...
C===================== CTEM =====================================\
     P            FCANCMX,   ICC, CTEM1, CTEM2, RMATC,    ZOLNC,  PAIC,
     Q               AILC, AILCG, CMASVEGC, AILCMIN,  AILCMAX, L2MAX, 
     Q             NOL2PFTS, SLAIC, ALVSCTM, ALIRCTM,    
C    ------------- CTEM INPUTS ABOVE THIS LINE, OUTPUTS BELOW --------|
     R             AILCGS,  FCANCS, FCANC )
C
...
C===================== CTEM =====================================/
C
C     * AUG 12/09 - Rong Li.    CHANGES MADE FOR COUPLING 
C                               CLASS3.4 WITH CTEM
