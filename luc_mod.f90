...
!-------------------------------------------------------------------------------------------------------------
SUBROUTINE INITIALIZE_LUC(IYEAR,LUCDAT,NMTEST,NLTEST,MOSAIC,ICC, &
                          ICAN,ICP1,NOL2PFTS,CYCLEMET,CYLUCYR,LUCYR,   &
                          FCANROW,FAREROW,NFCANCMXROW,PFCANCMXROW,     &
                          FCANCMXROW,REACH_EOF)
...
! UPDATES
REAL, DIMENSION(NLTEST,NMTEST,ICP1), INTENT(INOUT) :: FCANROW
REAL, DIMENSION(NLTEST,NMTEST),      INTENT(INOUT) :: FAREROW

! OUTPUTS
REAL, DIMENSION(NLTEST,NMTEST,ICC), INTENT(OUT) :: PFCANCMXROW
REAL, DIMENSION(NLTEST,NMTEST,ICC), INTENT(OUT) :: FCANCMXROW
REAL, DIMENSION(NLTEST,NMTEST,ICC), INTENT(OUT) :: NFCANCMXROW
         ...
         ENDIF
          ...
          DO I = 1, NLTEST
           ...
           IF (FAREROW(I,NMTEST) < SEED) THEN
             ...
             NFCANCMXROW= ADJUST_LUC_FRACS(I,NMTEST,NLTEST,ICC, &
...
SUBROUTINE READIN_LUC(IYEAR,NMTEST,NLTEST,MOSAIC,ICC,ICP1,LUCYR,   &
                      ICAN,NOL2PFTS,NFCANCMXROW,REACH_EOF)
...
FUNCTION ADJUST_LUC_FRACS(I,NMTEST,NLTEST,ICC,NFCANCMXROW,BARE_GROUND_FRAC) RESULT(OUTNFCROW)
...
INTEGER, INTENT(IN) :: NLTEST
INTEGER, INTENT(IN) :: ICC
REAL, DIMENSION(NLTEST,NMTEST,ICC), INTENT(IN) :: NFCANCMXROW
REAL, INTENT(IN) :: BARE_GROUND_FRAC

REAL, DIMENSION(NLTEST,NMTEST,ICC) :: OUTNFCROW
