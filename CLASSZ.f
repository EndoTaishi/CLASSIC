...
250       CONTINUE
C
C         FLAG! JM FEB 5 2012
C         MOSAIC MODE HAS SOME FAILS HERE, WE CHANGE THIS TO 1.5
C         IN OFF-LINE MODE TO ALLOW THE MODEL TO CONTINUE. THIS
C         WILL HAVE TO BE ADDRESSED AT SOME LATER TIME. 
           IF(ABS(CTVSTP(I)-QSUMV).GT.1.0) THEN
!           IF(ABS(CTVSTP(I)-QSUMV).GT.1.5) THEN
