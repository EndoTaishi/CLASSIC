...
C     ALL MODEL SWITCHES ARE READ IN FROM A NAMELIST FILE
     ...
     2             METCYLYRST,CO2ON,SETCO2CONC,POPDON,PARALLELRUN,
     3             COMPETE,RSFILE,IDISP,IZREF,ISLFD,IPCP,ITC,ITCG,
     4             ITG,IWF,IPAI,IHGT,IALC,IALS,IALG,JHHSTD,JHHENDD,
     5             JDSTD,JDENDD,JHHSTY,JHHENDY,JDSTY,JDENDY)
C     <<<<<MJ EDIT
...
C     A RUN WITH CYCLING MET. 
      ...
      IF (CYCLEMET .AND. IYEAR .NE. METCYLYRST) THEN     
