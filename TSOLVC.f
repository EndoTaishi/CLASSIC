...
C     * ARRAYS FOR CTEM.
C
CC     * AILCG    - GREEN LAI FOR CARBON PURPOSES
...
C             USE TA. JM 11/09/12

        CALL PHTSYN(  AILCG, FCANC,     TCAN, CO2CONC,  PRESSG,    FI,
...
C         CTEM REPLACES TCAN(IBAD) WITH TA(IBAD) IN CASE TCAN IS TOO HIGH 
C
          TCAN(IBAD)=TA(IBAD)
C         CALL XIT('TSOLVC',-2)
      ENDIF
