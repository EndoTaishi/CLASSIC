...
C
      IF (LNDUSEON) THEN
         ...
         CALL INITIALIZE_LUC(IYEAR,ARGBUFF,NMTEST,NLTEST,MOSAIC,ICC, 
     1                     ICAN,ICP1,NOL2PFTS,CYCLEMET,CYLUCYR,LUCYR,   
     2                     FCANROW,FAREROW,NFCANCMXROW,PFCANCMXROW,     
     3                     FCANCMXROW,REACH_EOF)
...
C      READ IN THE LUC DATA NOW
       ...
       IF (CTEM2 .AND. LNDUSEON .AND. .NOT. CYCLEMET) THEN
         ...
         CALL READIN_LUC(IYEAR,NMTEST,NLTEST,MOSAIC,ICC,ICP1,LUCYR,   
