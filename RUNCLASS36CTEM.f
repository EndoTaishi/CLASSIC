...
C  ADD FOR COMPETE
     ...
     7      MMROW(NLAT,NMOS,ICC), MMGAT(ILG,ICC)
       ...
       INTEGER PFTEXISTROW(NLAT,NMOS,ICC), PFTEXISTGAT(ILG,ICC)
...
C      WRITE(*,*)'YEAR=',IYEAR,'DAY=',IDAY,' HOUR=',IHOUR,' MIN=',IMIN
          ...
          ULGRD(I)=UVGRD(I)
          VLGRD(I)=0.0
          VMODGRD(I)=UVGRD(I)  !FLAG, THE MIN WITH VMIN IS DONE IN CLASST. JM.
250   CONTINUE
C
...
C JM FLAG NO LONGER PASSED VARS  ,AILCMINGAT, AILCMAXGAT,      
...
C
     ...
     P  CO2I1CSGAT,CO2I2CGGAT,CO2I2CSGAT,CSZGRD,XDIFFUSGAT,SLAIGAT,ICC,
