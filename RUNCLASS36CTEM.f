...
C       NOTE WE LOAD THE NFCANCMX, NOT PFCANCMX ARRAY. THIS IS BECAUSE THIS
C       NFCANCMX VALUE IS PASSED TO THE PFCANCMX ARRAY AT THE START OF EACH SIMULATION
C       YEAR
        ...
        ENDDO !NLTEST
C
C       NEXT UPDATE OUR LUC DATA IF EITHER OF THE FOLLOWING CONDITIONS ARE MET:
C       1) WE ARE CYCLING THE MET DATA AND THE LUC YEAR WE JUST READ IN IS LESS
C       THAN THE YEAR WE WANT TO CYCLE OVER (ASSUMING IT IS NOT DEFAULTED TO 
C       -9999) OR,
C       2) WE ARE NOT CYCLING OVER THE MET DATA SO WE JUST WANT TO GET THE SAME
C       YEAR OF LUC DATA AS THE MET DATA WE READ IN ABOVE IN PREPARATION FOR OUR
C       TRANSIENT RUN.
