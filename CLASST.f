     ...
     Z   LFSTATUS) 
C
C     * JAN 14/15 - J.MELTON.   REMOVE FIELDSM (DUPLICATE OF THFC) AND RENAME WILTSM TO THLW FOR
...
C
      REAL THLW(ILG,IG), FIELDSM(ILG,ig) ! FLAG!
C
...
C                                     
     ...
     K                THLIQC,THFC,THLW,ISAND,IG,COSZS,PRESSG,FIELDSM,
