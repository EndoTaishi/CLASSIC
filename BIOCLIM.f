...
C 
      IMPLICIT NONE
C
      INTEGER IDAY, IL1, IL2, ILG, INIBOCLM
C
...
C
      DO 240 I = IL1, IL2
          TCURM(I)=TCURM(I)+(TA(I)-273.16)*(1.0/MONTHDAYS(CURMONTH))
          GDD5CUR(I)=GDD5CUR(I)+MAX(0.0, (TA(I)-273.16-5.0))
          ANPCPCUR(I)=ANPCPCUR(I) + PRECIP(I)
C         NET RADIATION (W/M2) x 12.87 = POTENTIAL EVAP (MM)
          ANPECUR(I)=ANPECUR(I) + NETRAD(I)*12.87*(1.0/365)
          WTRBAL=PRECIP(I)-(NETRAD(I)*12.87*(1.0/365))
