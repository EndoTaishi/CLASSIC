...
c    -------------- inputs above this line, outputs below -------------
     5                 ltresveg, scresveg, 
     6              ipeatland, iday, psisatpt, thporpt, bipt,thice)    !YW
...
c     thice     - liquid soil moisture content in 3 soil layers in canopy  
c                 covered subarea, differs in thice in ctem.f. YW  
