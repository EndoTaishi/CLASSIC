...
use ctem_params,  only : nlat, nmos, ilg, ican, ignd,icp1, icc, iccp1, iccp2, &
...
use ctem_params, only : ican, icc,iccp2,ilg,nlat,nmos,ignd
...
use ctem_params, only : nlat, nmos, ican, ignd ,icc, iccp2
...
use ctem_params, only : iccp2,icc
