...
C
      ...
      REAL RML_VEG(ILG,ICC) !<LEAF RESPIRATION RATE, (\f$\mu mol CO_2 m^{-2} s^{-1}\f$) FOR EACH PFT
      REAL AN_VEG(ILG,ICC)  !<NET PHOTOSYNTHESIS RATE, (\f$\mu mol CO_2 m^{-2} s^{-1}\f$) FOR EACH PFT
