...
C
     ...
     1        NOL2PFTS(IC),   K1,   K2,  IC, M,  ISAND(ILG,IG)
C
...
C
     ...
     4           Q10FUNC,              ZERO,      LIVSTMFR(ILG,ICC),
...
C     ORIGINAL VALUES:
C      DATA BSRTSTEM/0.2224, 0.0350, 0.0000,
C     &              0.0150, 0.0300, 0.0300,
C     &              0.0365, 0.0365, 0.0000,
...
C     ORIGINAL VALUES:
C      DATA BSRTROOT/0.5521, 0.1150, 0.0000,
C     &              0.0550, 0.0550, 0.0550,
C     &              0.1600, 0.1600, 0.0000,
