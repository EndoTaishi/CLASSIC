!>\file
C!Calculate decrease in snow albedo and increase in density due to aging.
C!@author D. Verseghy, M. Lazare, R. Brown, F. Seglenieks, Y. Delange, R. Harvey
!>
