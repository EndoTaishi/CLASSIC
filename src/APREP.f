...
C
C    ----------------- CTEM MODIFICATIONS ------------------------/
C     * OCT 20/09 - R. Li       MAKE MODIFICATIONS TO GET BACK THE 
C     *                         CAPABILITY TO RUN THE COUPLED MODEL 
C     *                         WITH CTEM1(TRUE) AND CTEM2(FALSE) 
C     *
C     * AUG 31/08 - V. ARORA    MAKE CHANGES TO INCLUDE COUPLING WITH
C     *                         CTEM 1.0. LEAF AND PLANT AREA INDICES,
C     *                         ROUGHNESS LENGTH AND CANOPY MASS VALUES
C     *                         ARE REPLACED WITH THOSE FROM CTEM WHEN
C     *                         CTEM IS SWITCHED ON. ALL MODIFICATIONS
C     *                         ARE CLEARLY MARKED.
...
C
C    ----------------- CTEM MODIFICATIONS ------------------------\
C CTEM: replaced K1 and K2 with K1C and K2C, respectively
...
CRLi            AIL(I,2)=MIN((PAI(I,2)-PAIMIN(I,2)),0.0)
...
C    ----------------- CTEM MODIFICATIONS ------------------------\
C
C         CHANGE LAI THRESHOLD FOR REDUCING FCAN FROM 1.0 TO 0.05
