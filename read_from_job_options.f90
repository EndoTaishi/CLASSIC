subroutine read_from_job_options(ARGBUFF,CTEMLOOP,CTEM1,CTEM2,NCYEAR,LNDUSEON,SPINFAST,CYCLEMET, &
                  ...
                  PARALLELRUN,COMPETE,RSFILE,IDISP,IZREF,ISLFD,IPCP,ITC,ITCG, &
...
logical, intent(out) :: CYCLEMET ! TO CYCLE OVER ONLY A FIXED NUMBER OF YEARS 
 				 ...
 				 ! IF POPDON IS TRUE, IT WILL CHOOSE THE POPN DATA FOR YEAR
...
integer, intent(out) :: POPCYCLEYR ! POPD YEAR TO CYCLE ON WHEN CYCLEMET IS TRUE, SET TO -9999
				 ! TO CYCLE ON METCYLYRST
