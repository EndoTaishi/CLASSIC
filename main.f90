...
contains
    ...
    subroutine CLASSIC_driver(gridCellIndex)
        !
        !>
        !!------------------------------------------------------------------
        ...
        !allocate(class_gat)
        !allocate(class_rot)
        integer, intent(in) :: gridCellIndex
        ...
        print*, "I'm grid cell", gridCellIndex, "out of", validCount, "with lon/lat", validLon(gridCellIndex), validLat(gridCellIndex)
