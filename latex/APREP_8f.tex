...
For snow interception on the canopy, a modified calculation of the plant area indices $\Lambda_{p,0}$ and $\Lambda_{p,s}$ is performed, assigning a weight of 0.\+7 to the plant area index of needleleaf trees, to account for the effect of needle clumping. The interception capacity for snow, $W_{f,max}$, is calculated following Bartlett et al. (2006) \cite{Bartlett2006-xp}, using a relation developed by Schmidt and Gluns (1991)\+: $W_{f,max} = 6.0 \Lambda_p [0.27 + 46.0 \rho_{s,f} ]$ where
...
\begin{center}
\leavevmode
\includegraphics[width=188pt]{APREP_8f_a5fe4fa336815bc509d646edae0744405_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=204pt]{APREP_8f_a5fe4fa336815bc509d646edae0744405_icgraph}
\end{center}
\end{figure}
