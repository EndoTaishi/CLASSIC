...
#
OBJ = APREP.o CLASSBD.o GRALB.o SNOALBA.o TNPREP.o WFILL.o CANADD.o CLASSD.o GRDRAN.o SNOALBW.o  TPREP.o WFLOW.o CANALB.o CLASSG.o GRINFL.o SNOVAP.o TSOLVC.o WPREP.o CTEMG1.o BIO2STR.o CTEMS1.o CTEMG2.o PHTSYN3.o CANVAP.o CLASSI.o CWCALC.o ICEBAL.o SUBCAN.o TSOLVE.o XIT.o CGROW.o CLASSS.o DIASURFZ.o SCREENRH.o RUNCLASS36CTEM.o TFREEZ.o TSPOST.o CHKWAT.o CLASST.o DRCOEF.o SLDIAG.o TMCALC.o TSPREP.o CLASSA.o CLASSW.o FLXSURFZ.o SNINFL.o TMELT.o TWCALC.o CLASSB.o CLASSZ.o GATPREP.o SNOADD.o TNPOST.o WEND.o CTEM.o BALCAR.o GAUSSG.o ORDLEG.o TRIGL.o LUC.o MAINRES.o HETRESV.o HETRESG.o ALLOCATE.o PHENOLGY.o TURNOVER.o MORTALTY.o DISTURB.o CTEMS2.o BIOCLIM.o EXISTENCE.o COMPETITION.o COMPETITION_MAP.o COMPETITION_UNMAP.o read_from_job_options.o
