...
OBJ = fileIOModule.o classic_params.o ctem_statevars.o class_statevars.o peatlands_mod.o \
	...
	TNPOST.o WEND.o balanceCarbon.o autotrophicRespiration.o allocate.o phenolgy.o turnover.o mortality.o \
	disturb.o ctems2.o landuse_change_mod.o soil_ch4uptake.o \
	competition_mod.o heterotrophicRespiration.o ctemUtilities.o soilC_processes.o ctemDriver.o outputManager.o prepareOutputs.o  \
