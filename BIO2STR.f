...
C	THIS IS A BUG FIX. CLASS WAS CRASHING WITH THE LOWER PAI. 
C	FEB 27 2012 V. ARORA AND J. MELTON
C         PAI(I,J)=MAX(0.3,PAI(I,J))
          PAI(I,J)=MAX(0.5,PAI(I,J))
...
C	  INSTABILITY ISSUES
C          CMASVEGC(I,J)=MAX(CMASVEGC(I,J),3.0)
          CMASVEGC(I,J)=MAX(CMASVEGC(I,J),5.0)
C
640     CONTINUE
630   CONTINUE
C
