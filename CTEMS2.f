...
C
C         COMPETITION RELATED VARIABLES
C          LYGLFMASROW(ILMOS(K),JLMOS(K),L) = LYGLFMASGAT(K,L)
C          GEREMORTROW(ILMOS(K),JLMOS(K),L) = GEREMORTGAT(K,L)
C          INTRMORTROW(ILMOS(K),JLMOS(K),L) = INTRMORTGAT(K,L)
C          LAMBDAROW(ILMOS(K),JLMOS(K),L)   = LAMBDAGAT(K,L)
C          PFTEXISTROW(ILMOS(K),JLMOS(K),L) = PFTEXISTGAT(K,L)
C          BURNVEGROW(ILMOS(K),JLMOS(K),L)  = BURNVEGGAT(K,L)
C          CCROW(ILMOS(K),JLMOS(K),L)       = CCGAT(K,L)
C          MMROW(ILMOS(K),JLMOS(K),L)       = MMGAT(K,L)
C
101   CONTINUE
C
      DO 102 L=1,ICC+1
