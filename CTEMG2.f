...
C
     ...
     D      RHGRD(NLAT),SDEPROW(NLAT,NMOS)
...
C  ADD FOR COMPETE
          LYGLFMASGAT(K,L)=LYGLFMASROW(ILMOS(K),JLMOS(K),L)
          GEREMORTGAT(K,L)=GEREMORTROW(ILMOS(K),JLMOS(K),L)
          INTRMORTGAT(K,L)=INTRMORTROW(ILMOS(K),JLMOS(K),L)
          LAMBDAGAT(K,L)=LAMBDAROW(ILMOS(K),JLMOS(K),L)
