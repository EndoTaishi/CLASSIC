      SUBROUTINE CTEMG2(FCANCMXGAT,RMATCGAT,ZOLNCGAT,PAICGAT,
...
C  ADD FOR COMPETE
C     &      LYGLFMASGAT, GEREMORTGAT, INTRMORTGAT,  LAMBDAGAT,
C     &      PFTEXISTGAT, BURNVEGGAT,  CCGAT,        MMGAT,
...
C  ADD FOR COMPETE
C     &      LYGLFMASROW, GEREMORTROW, INTRMORTROW,  LAMBDAROW,
C     &      PFTEXISTROW, BURNVEGROW,  CCROW,        MMROW )
C
C     * July 28/09 - Rong Li. GATHER OPERATION ON CTEM 
C     *                         VARIABLES.
C 
      IMPLICIT NONE
C
...
C     2      PFTEXISTROW(NLAT,NMOS,ICC),PFTEXISTGAT(ILG,ICC)
...
C     4      BURNVEGROW(NLAT,NMOS,ICC), BURNVEGGAT(ILG,ICC),
C     5      CCROW(NLAT,NMOS,ICC), CCGAT(ILG,ICC),
C     6      MMROW(NLAT,NMOS,ICC), MMGAT(ILG,ICC)
C
C----------------------------------------------------------------------
      DO 100 K=1,NML
...
C  ADD FOR COMPETE
C          LYGLFMASGAT(K,L)=LYGLFMASROW(ILMOS(K),JLMOS(K),L)
C          GEREMORTGAT(K,L)=GEREMORTROW(ILMOS(K),JLMOS(K),L)
C          INTRMORTGAT(K,L)=INTRMORTROW(ILMOS(K),JLMOS(K),L)
C          LAMBDAGAT(K,L)=LAMBDAROW(ILMOS(K),JLMOS(K),L)
C          PFTEXISTGAT(K,L)=PFTEXISTROW(ILMOS(K),JLMOS(K),L)
C          BURNVEGGAT(K,L)=BURNVEGROW(ILMOS(K),JLMOS(K),L)
C          CCGAT(K,L)=CCROW(ILMOS(K),JLMOS(K),L)
C          MMGAT(K,L)=MMROW(ILMOS(K),JLMOS(K),L)
