...
! allocate(class_gat%SPCPGAT(ilg),class_gat%TAGAT(ilg),class_gat%TADPGAT(ilg),class_gat%TRPCGAT(ilg),class_gat%TSPCGAT(ilg),class_gat%ULGAT(ilg),class_gat%VLGAT(ilg))
! allocate(class_gat%VMODGAT(ilg),class_gat%VPDGAT(ilg),class_gat%Z0ORGAT(ilg),class_gat%ZBLDGAT(ilg),class_gat%ZDHGAT(ilg),class_gat%ZDMGAT(ilg),class_gat%ZRFHGAT(ilg))
! allocate(class_gat%ZRFMGAT(ilg),class_gat%FSGGAT(ilg),class_gat%FLGGAT(ilg),class_gat%GUSTGAT(ilg),class_gat%DEPBGAT(ilg),class_gat%GTBS(ilg),class_gat%SFCUBS(ilg))
! allocate(class_gat%SFCVBS(ilg),class_gat%USTARBS(ilg),class_gat%TCSNOW(ilg),class_gat%GSNOW(ilg),class_gat%ALIRGAT(ilg),class_gat%ALVSGAT(ilg),class_gat%CDHGAT(ilg))
! allocate(class_gat%CDMGAT(ilg),class_gat%DRGAT(ilg),class_gat%EFGAT(ilg),class_gat%FLGGGAT(ilg),class_gat%FLGSGAT(ilg),class_gat%FLGVGAT(ilg),class_gat%FSGGGAT(ilg))
