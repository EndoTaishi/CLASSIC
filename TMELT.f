...
C
      ...
      REAL QMELT (ILG)  !Energy available for melting of snow [W m-2] 
      REAL R     (ILG)  !Rainfall rate [m s-1]
      REAL TR    (ILG)  !Temperature of rainfall [C] 
      REAL GZERO (ILG)  !Heat flow into soil surface [W m-2] 
      REAL RALB  (ILG)  !Rainfall rate saved for snow albedo 
                        !calculations [m s-1] 
      REAL HMFN  (ILG)  !Energy associated with freezing or thawing of 
                        !water in the snow pack [W m-2]
...
C-----------------------------------------------------------------------
      ...
      !0 C and melt it completely is calculated as HCONV. If HADD <= 
